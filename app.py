...
with tabs[0]:
    ...
    with col1:
        ...
        <p style="margin-bottom: 10px; color: #4A4458;">Upload your resume in PDF, DOCX, or TXT format.</p>
        <p style="color: #4A4458;">We'll analyze your resume and extract key information to help you find matching jobs.</p>
        </div>
        """, unsafe_allow_html=True)
